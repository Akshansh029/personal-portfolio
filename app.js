...
document.getElementById("NoteNest-link").addEventListener("click", (event) => {
  window.open("https://github.com/Akshansh029/NoteNest-app");
});
...
document
  .getElementById("Rock-paper-scissors-link")
  .addEventListener("click", (event) => {
    window.open("https://rock-paper-scissors-29.netlify.app/");
  });
document
  .getElementById("VelocityMart-link")
  .addEventListener("click", (event) => {
    window.open("https://github.com/Rohan231203/Solvathon-VelocityMart");
  });
document.getElementById("ChatApp-link").addEventListener("click", (event) => {
  window.open("https://github.com/Akshansh029/React-Firebase-Chat-Application");
});
